...
custom_hooks = [
    ...
    dict(
            ...
            recipient_email='kmh1102@126.com',
            send_address='2210785195@qq.com',
            password='yvnllefkecphdjhb'
        )
]
data_root = '/data/home/user12/dl-projects/datasets/WDD'
...
interval = 10
load_from = 'checkpoints/yolox/yolox_x_8x8_300e_coco_20211126_140254-1ef88d67.pth'
log_level = 'INFO'
log_processor = dict(by_epoch=True, type='LogProcessor', window_size=50)
max_epochs = 300
metainfo = dict(
    classes=('wheel', ), palette=[
        (
            220,
            20,
            60,
...
optim_wrapper = dict(
    optimizer=dict(
        lr=0.002, momentum=0.9, nesterov=True, type='SGD', weight_decay=0.0005),
...
test_evaluator = dict(
    ann_file='/data/home/user12/dl-projects/datasets/WDD/annotations/test.json',
    backend_args=None,
    metric='bbox',
    type='CocoMetric')
test_pipeline = [
...
val_dataloader = dict(
    ...
    sampler=dict(shuffle=False, type='DefaultSampler'))
val_evaluator = dict(
    ann_file='/data/home/user12/dl-projects/datasets/WDD/annotations/val.json',
    backend_args=None,
    metric='bbox',
    type='CocoMetric')
vis_backends = [
